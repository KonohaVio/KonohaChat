...
class Welcome (groupList : ContactList<Group>){
    ...
    private val defaultMsg = WelcomeMessage("欢迎新大佬～", null)
    ...
    suspend fun onMemberJoin(event : MemberJoinEvent) {
        ...
        if (groupWelcomeMessages.containsKey(groupId)) {
            ...
            val picture = this::class.java.getResource("/QuestionAnswer/welcome2.jpg")
            event.group.sendImage(picture)
...
//            val picture = this::class.java.getResource("/QuestionAnswer/welcome.jpg")
//            event.group.sendImage(picture)
//        }
//    }
}